...
class BeersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post beers_url, params: { beer: { description: @beer.description, food: @beer.food, name: @beer.name } }
    end
  ...
  test "should update beer" do
    patch beer_url(@beer), params: { beer: { description: @beer.description, food: @beer.food, name: @beer.name } }
